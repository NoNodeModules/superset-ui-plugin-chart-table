 ...
 */
export declare type QueryFormMetric = SavedMetric | AdhocMetric;
/**
 ...
 */
export declare type QueryFormColumn = string;
/**
 * Order query results by columns.
 * Format: [metric/column, is_ascending].
 */
export declare type QueryFormOrderBy = [QueryFormColumn | QueryFormMetric, boolean];
 ...
 */
export declare type QueryField = keyof QueryFields;
/**
 ...
 */
export declare type QueryFieldAliases = {
...
export declare type QueryFormData = DruidFormData | SqlaFormData;
