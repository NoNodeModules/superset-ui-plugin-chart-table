...
export declare const ControlFormItemComponents: {
    Slider: React.ForwardRefExoticComponent<(import("antd").SliderSingleProps & React.RefAttributes<unknown>) | (import("antd/lib/slider").SliderRangeProps & React.RefAttributes<unknown>)>;
    InputNumber: (<T extends import("../..").Formattable = import("../..").Formattable>(props: import("antd").InputNumberProps<T> & {
