 ...
 */
export default function ColumnConfigControl<T extends ColumnConfig>({ queryResponse, value, onChange, configFormLayout, ...props }: ColumnConfigControlProps<T>): JSX.Element | null;
