...
const columnWidth = {
  ...
  label: t('Width'),
  description: t('Default column width in pixels, may still be restricted by the shortest/longest word in the column'),
  width: 120,
  placeholder: 'auto',
  debounceDelay: 400,
...
const horizontalAlign = {
  ...
  debounceDelay: 50,
  defaultValue: 'left',
  options: [['left', ___EmotionJSX(FaAlignLeft, {
    title: t('Left')
  })], ['center', ___EmotionJSX(FaAlignCenter, {
    title: t('Center')
  })], ['right', ___EmotionJSX(FaAlignRight, {
    title: t('Right')
  })]]
};
const showCellBars = {
...
export const SHARED_COLUMN_CONFIG_PROPS = {
  ...
  d3SmallNumberFormat: { ...d3NumberFormat,
    ...
    description: t('D3 number format for numbers between -1.0 and 1.0, ' + 'useful when you want to have different siginificant digits for small and large numbers')
  },
  d3TimeFormat,
  fractionDigits,
  columnWidth,
...
export const DEFAULT_CONFIG_FORM_LAYOUT = {
  [GenericDataType.STRING]: [['columnWidth', {
    name: 'horizontalAlign',
    override: {
      defaultValue: 'left'
    }
  }]],
  [GenericDataType.NUMERIC]: [['columnWidth', {
    name: 'horizontalAlign',
    override: {
      defaultValue: 'right'
    }
  }], ['d3NumberFormat'], ['d3SmallNumberFormat'], ['alignPositiveNegative', 'colorPositiveNegative'], ['showCellBars']],
  [GenericDataType.TEMPORAL]: [['columnWidth', {
    name: 'horizontalAlign',
    override: {
      defaultValue: 'left'
    }
  }], ['d3TimeFormat']],
  [GenericDataType.BOOLEAN]: [['columnWidth', {
    name: 'horizontalAlign',
    override: {
      defaultValue: 'left'
    }
