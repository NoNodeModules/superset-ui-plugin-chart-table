...
export function MetricOption({
  ...
  const link = url ? ___EmotionJSX("a", {
    href: url,
    target: openInNewWindow ? '_blank' : '',
    rel: "noreferrer"
  }, verbose) : verbose;
  const warningMarkdown = metric.warning_markdown || metric.warning_text;
  return ___EmotionJSX(FlexRowContainer, {
    className: "metric-option"
  }, showType && ___EmotionJSX(ColumnTypeLabel, {
    type: "expression"
  }), metric.is_certified && ___EmotionJSX(CertifiedIconWithTooltip, {
    metricName: metric.metric_name,
    certifiedBy: metric.certified_by,
    details: metric.certification_details
  }), ___EmotionJSX("span", {
    className: "option-label"
  }, link), metric.description && ___EmotionJSX(InfoTooltipWithTrigger, {
    className: "text-muted",
    icon: "info",
    tooltip: metric.description,
    label: `descr-${metric.metric_name}`
  }), showFormula && ___EmotionJSX(InfoTooltipWithTrigger, {
    className: "text-muted",
    icon: "question-circle-o",
    tooltip: metric.expression,
    label: `expr-${metric.metric_name}`
  }), warningMarkdown && ___EmotionJSX(InfoTooltipWithTrigger, {
    className: "text-warning",
    icon: "warning",
    tooltip: ___EmotionJSX(SafeMarkdown, {
